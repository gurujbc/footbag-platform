...
Scaffolding only (not wired up yet). Today three separate UUID5 namespaces
and three different input-normalization regimes exist in the pipeline:
  ...
  - pipeline/04_build_analytics.py             namespace 3b5d5c7e-... , no normalization
...
normalization), so it is intentionally deferred.
